...
export const useHomeStore = defineStore('home', {
  state: () => ({
    recentChats: [
      ...
      { date: '2026-04', title: '微信小程序报价方案', active: true },
      { date: '', title: '图文营销方案' },
      { date: '', title: '出一套商标布局方案', muted: true },
      { date: '', title: '邮件营销方案' },
      { date: '', title: '公司整体营销方案' },
      { date: '2026-03', title: '官网报价方案' },
    ...
    features: [
      ...
      { title: '市场反馈', description: '倾听用户优化策略', variant: 'diamond', active: true },
      { title: '生态伙伴', description: '携手同行共建生态', variant: 'planet' },
    ] as FeatureCard[],
  }),
})
